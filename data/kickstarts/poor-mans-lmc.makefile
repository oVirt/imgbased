...
vmlinuz:
	curl -O $(FEDORA_URL)/isolinux/vmlinuz

initrd.img:
	curl -O $(FEDORA_URL)/isolinux/initrd.img

squashfs.img:
	curl -O $(FEDORA_URL)/LiveOS/squashfs.img

run-install: vmlinuz initrd.img squashfs.img $(DISK_NAME)
